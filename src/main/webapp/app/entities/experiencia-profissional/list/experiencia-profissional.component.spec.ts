...
describe('Component Tests', () => {
  describe('ExperienciaProfissional Management Component', () => {
    let comp: ExperienciaProfissionalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExperienciaProfissionalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.experienciaProfissionals?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
