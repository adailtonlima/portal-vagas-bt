...
describe('Component Tests', () => {
  describe('AreaAtuacao Management Component', () => {
    let comp: AreaAtuacaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AreaAtuacaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.areaAtuacaos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
