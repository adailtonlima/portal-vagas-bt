...
describe('Component Tests', () => {
  describe('Idioma Management Component', () => {
    let comp: IdiomaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IdiomaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.idiomas?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
