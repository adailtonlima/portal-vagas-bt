...
describe('Component Tests', () => {
  describe('Formacao Management Component', () => {
    let comp: FormacaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FormacaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.formacaos?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
