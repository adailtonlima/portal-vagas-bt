...
describe('Component Tests', () => {
  describe('PerfilProfissional Management Component', () => {
    let comp: PerfilProfissionalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PerfilProfissionalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.perfilProfissionals?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
